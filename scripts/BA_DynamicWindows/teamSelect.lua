...
RegisterCommand{Command="selectTeam", AccessLevel = AccessLevel.Mortal, Func=DefaultCommandFuncs.teamSelect, Usage="nothing yet", Desc="Opens a window for the user to select their team" }